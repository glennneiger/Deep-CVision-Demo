...
func main() {
	...
	var speechctx []*speechpb.SpeechContext
	speechctx = append(speechctx,&speechpb.SpeechContext{Phrases: []string{"röd","grön","blå","skapa","rita","stor","liten","cirkel","fyrkant","höger","vänster","upp","ner","större","mindre"}})
